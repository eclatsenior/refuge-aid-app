-- Fix training_completion calculation to properly calculate weighted average
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'training_completion', (
      -- CÁLCULO CORREGIDO: Suma total de videos completados / (empleadas × total videos) × 100
